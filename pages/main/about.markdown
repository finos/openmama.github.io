...
The OpenMAMA Project is an open source project hosted under the auspices of the [Linux Foundation](http://www.linuxfoundation.com/). It is developed and designed using a collaborative effort by an open community of professionals and volunteers -- collectively known as contributors. Contributors include anyone that is positively contributing to the OpenMAMA Project.
...
**[OpenMAMA Governance](http://www.slideshare.net/OpenMAMA/open-mama-governence-12590714 "OpenMAMA Governance") **from **[OpenMAMA](http://www.slideshare.net/OpenMAMA)**

You can dowload the presentation in a pdf format by clicking here

Joining the Steering Committee
------------------------------

To join the OpenMAMA Steering Committee, organizations must sign the [OpenMAMA Steering Committee Application](contact.html) and join the [Linux Foundation](http://www.linuxfoundation.org/about/join/corporate) as a member.
...
![Governance Diagram](assets/images/GovernenceBanner.png)
...
Visit us at [www.tradevela.com](http://www.tradevela.com/). Follow us on Twitter @TradeVela.
