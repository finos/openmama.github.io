...
|                | Name           |
| -------------- | -------------- |
|  | **[MAMA_STATUS_BASE](status_8h.html#define-mama-status-base)**  |
|  | **[MAMA_STATUS_MAX](status_8h.html#define-mama-status-max)**  |
|  | **[NULLARG_STATUS_CHECK](status_8h.html#define-nullarg-status-check)**(x)  |
|  | **[NULLARG_STATUS_CHECK_STR](status_8h.html#define-nullarg-status-check-str)**(x)  |
|  | **[NOMEM_STATUS_CHECK](status_8h.html#define-nomem-status-check)**(x)  |
